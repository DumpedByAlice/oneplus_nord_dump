...
cat system_ext/priv-app/OnePlusCamera/OnePlusCamera.apk.* 2>/dev/null >> system_ext/priv-app/OnePlusCamera/OnePlusCamera.apk
rm -f system_ext/priv-app/OnePlusCamera/OnePlusCamera.apk.* 2>/dev/null
...
cat system_ext/app/OPWallpaperResources/OPWallpaperResources.apk.* 2>/dev/null >> system_ext/app/OPWallpaperResources/OPWallpaperResources.apk
rm -f system_ext/app/OPWallpaperResources/OPWallpaperResources.apk.* 2>/dev/null
